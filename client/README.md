...
![TH-Store Image Banner](https://res.cloudinary.com/dfmwnhbap/image/upload/v1727857701/olu6tel5ztfty5qapien.png)
)
...
- **Koa:** Koa is a new web framework designed by the team behind Express, which aims to be a smaller, more expressive, and more robust foundation for web applications.
...
- **Authentication:** TH-Store includes features for Google login, user registration, email verification, forgot password, reset password, and profile updates.
...
- **Typescript + Next.js App Directory:** TH-Store leverages TypeScript in combination with Next.js, enhancing code reliability and maintainability.
...
- **Responsive Layout Design:** TH-Store is fully responsive across all devices, providing a seamless experience for your customers.
...
- **Koa:** Create a robust backend for your eCommerce website using Koa.
...
- **Flexible and Multi-Purpose:** TH-Store is versatile and can be adapted to various eCommerce niches.
...
- **All E-commerce Features and Apps Included:** TH-Store provides a comprehensive eCommerce solution with all the essential features and apps needed for a successful online store.
...
To get started with TH-Store, follow these steps:
...
[TH-Store Client Side Live Link](https://comestic-ecommerce-client.vercel.app/)

## Server Side Live Link

[TH-Store Server Side Live Link](https://github.com/ThinhHoangIT/comestic-ecommerce-client.git)

## Client Side Repo

[TH-Store Client Side Repo](https://github.com/ThinhHoangIT/comestic-ecommerce-client.git)

## Server Side Repo

[TH-Store Server Side Repo](https://github.com/ThinhHoangIT/cosmetic-backend.git)
